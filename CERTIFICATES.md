...
## 1. Fundamentals of DevOps On AWS

**Issuing Organization:** SimpliLearn (Powered by AWS)  
**Completion Date:** September 10, 2026  
**Credential ID:** 10716430  
**Status:** ✅ Active

### Description
Professional certification in DevOps fundamentals on AWS, covering cloud infrastructure automation, CI/CD pipelines, infrastructure as code, and core AWS services essential for DevOps engineering.
...
### Relevance
This certification validates practical DevOps skills and knowledge of AWS services, directly aligned with professional experience in:
- Infrastructure automation with Terraform and Ansible
- CI/CD pipeline development with GitHub Actions and Jenkins
...
### Description
Professional certification in Red Hat Enterprise Linux system administration, covering user management, file systems, networking, security, and system monitoring.
...
### Relevance
Validates expertise in Linux administration, directly applicable to:
...
## Certification Display on Portfolio

All certifications are displayed prominently in the **Certifications** section of the portfolio website at `/index.html#certifications`.
...
- Direct links to credential verification pages
- Credly integration for digital badge viewing
